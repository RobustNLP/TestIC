...
# test_file_name = 'ofa_1000_0/pred.final_result_test_0.tsv'
# bg_file_name = 'ofa_1000_bg/pred.bg_images.tsv'
...
with open('ofa_base_1000_0/name_img_id_dict.pkl', 'rb') as f:
