...
# 60 classes
single_list = ['cat', 'sheep', 'truck', 'bowl', 'airplane', 'giraffe', 'scissors', 'backpack', 'couch', 'cup', 'broccoli', 'person', 'kite', 'banana', 'bus', 'umbrella', 'chair', 'keyboard', 'bear', 'vase', 'handbag', 'microwave', 'snowboard', 'remote', 'cake', 'elephant', 'cow', 'motorcycle', 'sandwich', 'bottle', 'oven', 'boat', 'apple', 'car', 'laptop', 'zebra', 'bicycle', 'carrot', 'pizza', 'toilet', 'sink', 'bed', 'tie', 'book', 'horse', 'orange', 'bird', 'surfboard', 'suitcase', 'bench', 'dog', 'frisbee', 'refrigerator', 'skateboard', 'clock', 'train', 'spoon', 'fork', 'toothbrush', 'toaster']
plural_list = ['cats', 'sheep', 'trucks', 'bowls', 'airplanes', 'giraffes', 'scissors', 'backpacks', 'couches', 'cups', 'broccolis', 'people', 'kites', 'bananas', 'buses', 'umbrellas', 'chairs', 'keyboards', 'bears', 'vases', 'handbags', 'microwaves', 'snowboards', 'remotes', 'cakes', 'elephants', 'cows', 'motorcycles', 'sandwiches', 'bottles', 'ovens', 'boats', 'apples', 'cars', 'laptops', 'zebras', 'bicycles', 'carrots', 'pizzas','toilets', 'sinks', 'beds', 'ties', 'books', 'horses', 'oranges', 'birds', 'surfboards', 'suitcases', 'benches', 'dogs', 'frisbees', 'refrigerators', 'skateboards', 'clocks', 'trains', 'spoons', 'forks', 'toothbrushes', 'toasters']
...
test_file_name = 'azure_1000_bar2/pred.final_result_test_bar2.tsv'
